        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 text-[0.7rem] font-black tracking-[0.15em]">
            <button
              ...
              className={`transition-colors ${filter === 'ALL' ? 'text-accent' : 'text-[var(--color-text-dim)] hover:text-[var(--color-text-primary)]'}`}
            >
            ...
            {ALL_VENUES_EN.map(v => (
              <button
                key={v}
                onClick={() => setFilter(v)}
                className={`transition-colors ${filter === v ? 'text-accent' : 'text-[var(--color-text-dim)] hover:text-[var(--color-text-primary)]'}`}
              >
